...
path = "C:/Users/burcu/Desktop/Data"
...
file = open("C:/Users/burcu/Desktop/labels/" + str(lowerlimit) + "-"+str(upperlimit)+".txt","w")
fileWithNames = open("C:/Users/burcu/Desktop/labels/" + str(lowerlimit) + "-"+str(upperlimit)+"-names.txt","w") 
batchsize = 128;
for i in range(lowerlimit, upperlimit, batchsize):
	...
	for j in range(0, k):	
		dir = listdir[i + j];
		names[j] = dir;
		urls[j] = "http://46.101.173.29/" + dir + "/w342.jpg"
